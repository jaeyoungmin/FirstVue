  ...
  <div class="blog-view">
    ...
    <div class="wrapper">
      <v-row justify="center">
        <v-col cols="12" md="4" sm="3" v-for="(blog, i) in blogs" :key="i"
          ><!--cols 라는 가로 컬럼은 사이즈를 4칸을 가진다 - 총 12 -->
          <blog-item
            :title="blog.title"
            :imgUrl="blog.imgUrl"
            :text="blog.text"
      ...
      blogs: [
        {
          ...
          imgUrl:
            "https://lh3.googleusercontent.com/proxy/Pfypay4a48KsicpDXuIdH2UIq2gTwP-N7i-GNljB1bf0C6HzDeOiHInp0W3uiNyqmemo8ueVuiXQ9am4cZtNUY-MdC8IWgdmMDgLZfJNmd10Wu7pgfJt",
          text:
